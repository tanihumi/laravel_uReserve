      ...
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-4 mx-auto">
            ...
            <button onclick="location.href='{{ route( 'events.past' )}}'" class="mb-4 flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">過去イベント一覧</button>
